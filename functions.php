<?php 
		...
		// 	wp_enqueue_script( 'placemark', get_template_directfory_uri() . '/js/placemark.js');
		// 	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css');
		// 	wp_enqueue_script( 'style', get_template_directory_uri() . '/css/style.css');
		// 	wp_enqueue_script( 'slideout', 'https://cdnjs.cloudflare.com/ajax/libs/slideout/1.0.1/slideout.min.js');
		// 	wp_enqueue_script( 'yamap', 'https://api-maps.yandex.ru/2.1/?lang=ru_RU');
